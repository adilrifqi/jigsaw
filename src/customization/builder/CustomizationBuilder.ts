...
import { IntLitExpr } from './model/expr/num/IntLitExpr';
...
import { NotExpr } from './model/expr/bool/NotExpr';
import { NegativeExpr } from './model/expr/num/NegativeExpr';
import { BinaryNumOp, NumOp } from './model/expr/num/BinaryNumOp';
import { ComparisonExpr, CompOp } from './model/expr/bool/ComparisonExpr';
import { BinaryBoolOp, BoolOp } from './model/expr/bool/BinaryBoolOp';
import { Command } from './model/command/language/Command';
import { WhileCommand } from './model/command/language/WhileCommand';
import { IfElseCommand } from './model/command/language/IfElseCommand';
import { ScopeCommand } from './model/command/language/ScopeCommand';
...
import { NewEdgeExpr } from './model/expr/diagram/NewEdgeExpr';
import { NewNodeExpr } from './model/expr/diagram/NewNodeExpr';
...
import { EdgesOfExpr } from './model/expr/diagram/EdgesOfExpr';
import { HereExpr } from './model/expr/subject/HereExpr';
import { ParentsOfExpr } from './model/expr/subject/ParentsOfExpr';
import { ChildrenOfExpr } from './model/expr/subject/ChildrenOfExpr';
import { PropExpr } from './model/expr/ref/PropExpr';
import { AdditionExpr } from './model/expr/num/AdditionExpr';
import { ValueOfExpr } from './model/expr/ref/ValueOfExpr';
import { ArrayIndexReassignCommand } from './model/command/language/ArrayIndexReassignCommand';
import { TerminalNode } from 'antlr4ts/tree/TerminalNode';
import { ExprCommand } from './model/command/language/ExprCommand';
...
import { ParentVarExpr } from './model/expr/ref/ParentVarExpr';
import { ParentVarAssignCommand } from './model/command/language/ParentVarAssignCommand';
import { IsNullExpr } from './model/expr/bool/IsNullExpr';
import { MapType, NewMapExpr } from './model/expr/collection/NewMapExpr';
import { ConditionForLoopCommand } from './model/command/language/ConditionForLoopCommand';
import { CollectionForloopCommand } from './model/command/language/CollectionForLoopCommand';
