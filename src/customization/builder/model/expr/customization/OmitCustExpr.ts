...
export class OmitCustExpr extends Expr {
    ...
    public eval(): Object | null {
        ...
        if (exprType instanceof ArrayType) {
            ...
            const toOmit: NodeInfo[] | Subject[] | EdgeInfo[] = value as NodeInfo[] | Subject[] | EdgeInfo[];
            for (const obj of toOmit)
                result.push(this.runtime.omitDispatch(obj));
    
            return result;
        }

        return this.runtime.omitDispatch(value as NodeInfo | EdgeInfo | Subject | null);
    }
}